...
for B, A, S, E, L, G, M in permutations(range(10), 7):
    if B == 0 or G == 0:  
        continue
...
<img width="416" height="39" alt="image" src="https://github.com/user-attachments/assets/93d50594-4e15-44a0-9923-493ce1e02139" />
